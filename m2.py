...
class Cdvordaily(models.Model):
    ...
    f = models.ForeignKey('Navigation', models.DO_NOTHING, blank=True, null=True)
...
class Cdvormonthly(models.Model):
    ...
    a = models.ForeignKey(Airport, models.DO_NOTHING)
    emp = models.ForeignKey('Engineer', models.DO_NOTHING, blank=True, null=True)
    f = models.ForeignKey('Navigation', models.DO_NOTHING)
    p_id = models.AutoField(primary_key=True)
    status = models.CharField(max_length=30)
...
class Dscndaily(models.Model):
    ...
    f = models.ForeignKey(Communication, models.DO_NOTHING)
    emp = models.ForeignKey('Engineer', models.DO_NOTHING, blank=True, null=True)
    sat_led = models.CharField(db_column='SAT_LED', max_length=30, blank=True, null=True)  # Field name made lowercase.
    odu_led = models.CharField(db_column='ODU_LED', max_length=30, blank=True, null=True)  # Field name made lowercase.
    io_led = models.CharField(db_column='IO_LED', max_length=30, blank=True, null=True)  # Field name made lowercase.
    alarm_led = models.CharField(db_column='Alarm_LED', max_length=30, blank=True, null=True)  # Field name made lowercase.
    power_led = models.CharField(db_column='Power_LED', max_length=30, blank=True, null=True)  # Field name made lowercase.
    v35_led = models.CharField(db_column='V35_LED', max_length=30, blank=True, null=True)  # Field name made lowercase.
    ...
    coro_function = models.CharField(db_column='CorO_function', max_length=20, blank=True, null=True)  # Field name made lowercase.
    remarks = models.TextField(db_column='REMARKS', blank=True, null=True)  # Field name made lowercase.
    unit_incharge_approval = models.CharField(db_column='Unit_incharge_approval', max_length=3, blank=True, null=True)  # Field name made lowercase.
    approval_date = models.DateField(blank=True, null=True)
    approval_time = models.TimeField(blank=True, null=True)
...
class Dscnmlogs(models.Model):
    log_id = models.AutoField(primary_key=True)
    emp = models.ForeignKey('Engineer', models.DO_NOTHING)
    p = models.ForeignKey('Dscnmonthly', models.DO_NOTHING)
...
class Dscnwlogs(models.Model):
    log_id = models.AutoField(primary_key=True)
    emp = models.ForeignKey('Engineer', models.DO_NOTHING)
    p = models.ForeignKey(Dscnweekly, models.DO_NOTHING)
    value = models.CharField(max_length=30)
    remarks = models.CharField(max_length=100)
    date = models.DateField()
    time = models.TimeField()
...
class Equipments(models.Model):
    ...
    daily_f = models.IntegerField()
    weekly_f = models.IntegerField()
...
class Scctvdaily(models.Model):
    ...
    a = models.ForeignKey(Airport, models.DO_NOTHING)
    emp = models.ForeignKey(Engineer, models.DO_NOTHING, blank=True, null=True)
    f = models.ForeignKey('Surveillance', models.DO_NOTHING)
    ...
    recording_active_status_vrs_server = models.CharField(db_column='recording_active_status_VRS_server', max_length=30, blank=True, null=True)  # Field name made lowercase.
